...
def inject_base_styles():
    st.markdown(
        ...
        .tag-fact {{ background-color: rgba(255,255,255,0.06); color: {TEXT}; border: 1px solid {LINE}; }}
        .tag-interp {{ background-color: rgba(255,255,255,0.06); color: {TEXT}; border: 1px solid {LINE}; }}
        .tag-primary {{ background-color: rgba(255,255,255,0.06); color: {TEXT}; border: 1px solid {LINE}; }}
        ...
        /* Newer Streamlit tab implementation (React Aria) */
        [data-testid="stTab"] {{
            font-family: 'IBM Plex Mono', monospace !important;
            color: {GREY} !important;
        }}
        ...
        /* Multiselect selected-tag pills default to Streamlit's primaryColor;
           neutralize to match the rest of the site. */
...
def citation_line(author: str, year: str, title: str, venue: str = ""):
    ...
    st.markdown(
        ...
        f'color:#9AA5AD; padding-left:0.1rem; margin:0.4rem 0 1rem 0;">'
