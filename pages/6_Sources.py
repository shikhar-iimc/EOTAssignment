...
st.set_page_config(page_title="Sources", page_icon=None, layout="wide")
inject_base_styles()
...
st.markdown(
    """
    **Course materials cited in the essay but not listed above** (not externally linkable, distributed
    via the course pack):
    ...
    - Matten, D., Crane, A., and Moon, J. *Corporate responsibility for innovation: A citizenship framework*
    """
)
